...
class EditEventModal extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Button onClick={this.showDialog} color="primary" variant="text" size="small">
          Modifier
        </Button>
        <Dialog open={this.state.showDialog} onClose={this.closeDialog} maxWidth="md" fullWidth aria-labelledby="form-dialog-title">
